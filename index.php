...
<div class="container">
    <section class="section1">
        <div class="list-images">
            <img src="Image/slide3.webp" alt="" width="100%">
            <img src="Image/slide4.jpg" alt="" width="100%">
        </div>
        <div class="btns">
    ...
    <section class="section2">
        ...
        <div class="policies-item">
            <div class="policies-image">
                <img src="Image/policies_icon_4.png" alt="policies_icon_4.png" width="50" height="50"
                    class="img-fluid ">
            </div>
            <div class="policies-info ">
        ...
        <div class="flash_sale_main ">
            <div class="flash_sale_header ">
                <div class="flash_sale_heading ">
                    ...
                    <img src="https://theme.hstatic.net/200000696635/1001199686/14/flashsale-hot.png?v=8 "
                        alt="Flash Sale ">
                </div>
                ...
                <div class="product-item ">
                    <div class="flashsale-item ">
                        <div class="card ">
                            <div class="imgBx ">
                                <img
                                    src="https://shop.mancity.com/dw/image/v2/BDWJ_PRD/on/demandware.static/-/Sites-master-catalog-MAN/default/dwae233114/images/large/701225663001_pp_01_mcfc.png?sw=400&sh=400&sm=fit ">
                            </div>
                            <div class="contentBx ">
    ...
    <section class="section9 ">
        ...
        <iframe src="https://thethao247.vn/ " frameborder="0 " width="100% " height="500 "
            style="border:1px solid rgb(172, 172, 172); "></iframe>
    </section>
