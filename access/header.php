                            ...
                            <ul class="menu_sanpham">
                                <div class="menu_sp">
                                    <?php foreach ($categories as $category_id => $category_name): ?>
                                        <li>
                                            <a
                                                href="brand_product.php?category_id=<?php echo $category_id; ?>"><?php echo $category_name; ?></a>
                                            <ul class="menu_con">
                                                <?php foreach ($brands as $brand): ?>
                                                    <?php if ($brand['category_id'] == $category_id): ?>
                                                        <li><a
                                                                href="brand_product.php?category_id=<?php echo $category_id; ?>&brand_id=<?php echo $brand['brand_id']; ?>"><?php echo $brand['brand_name']; ?></a>
                                                        </li>
                                                    <?php endif; ?>
                                                <?php endforeach; ?>
                                            </ul>
